...
اخــتر من الأوامـر للتـخـميـن كـلمـات الـسر .
 ...
 يمكـنك مشـاهدة كلـمات الــسر مـاهــية . https://t.me/z3x5j/2721
المشاهده جميع باسوردات  """)
        elif lang == 'en':
            bot.send_message(message.chat.id, """— /pass_1 — [ 🇮🇶 ] — [ ✅ ]
...
def handle_iq_commands(message):
    ...
    if command == '/pass_1':
        ...
        pas = ['1122334455', '112233445566', '11223344556677', '123456123456', '1234512345', '12345671234567', '1122334455@', '12345@@', '12345@', '00998877', '10002000', '٠٩٨٧٦٥٤٣٢١', '1020304050', '20202020']
